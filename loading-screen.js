function loadSvgPaths(svgFilePath, targetSvgId, basePathId) {
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    if (!sessionStorage.getItem('introPlayed')) {
      ...
      // Animation already played this session — hide intro element immediately
      const introEl = document.querySelector('#loading-screen, .loading-overlay, #intro, .intro, .splash, .overlay, .hero-intro');
      if (introEl) {
