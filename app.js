...
//     const texts = Array.from(document.querySelectorAll('.card-text'));
//     let activeIndex = -1;

//     function updateActiveText(newActiveIndex) {
...
//             // Show the text corresponding to the active card
//             const currentText = document.getElementById(`text-card-${activeIndex}`);
//             if (currentText) {
//                 currentText.style.display = 'block';
//             }

//             // Update active class on project blocks
//             projectBlocks.forEach(block => block.classList.remove('active'));
//             if (projectBlocks[activeIndex]) {
//                 projectBlocks[activeIndex].classList.add('active');
//             }
//         }
//     }
...
//         root: stackContainer,
//         rootMargin: '0px',
//         threshold: [0.5] // Update at 50% visibility within container
//     };

//     const observer = new IntersectionObserver((entries) => {
//         entries.forEach(entry => {
//             const index = projectBlocks.indexOf(entry.target);
//             if (entry.isIntersecting && entry.intersectionRatio >= 0.5) {
//                 // Update active text for the card when it's at least 50% visible
...
// document.addEventListener('DOMContentLoaded', () => {
//     const imageElements = Array.from(document.querySelectorAll('.scroll-image'));
//     const observerOptions = {
...
//                 // Add a highlight to the visible image
//                 entry.target.style.border = '2px solid #007bff'; // Highlight visible image
//             } else {
//                 // Remove the highlight when the image is not visible
