...
const PLATFORM_ICONS = {
    ...
    'OCULUS GO':    '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><circle cx="10" cy="10" r="8"/><path d="M10 4 L16 10 L10 16 L4 10 Z"/></svg>',
    'QUEST 1':      '<svg width="20" height="20" viewBox="0 0 20 20"><rect rx="10" ry="10" width="20" height="11" x="0" y="4" fill="currentColor"/><rect rx="6" ry="6" width="12" height="6" x="4" y="6" fill="var(--bg)"/></svg>',
    'QUEST 2':      '<svg width="20" height="20" viewBox="0 0 20 20"><rect rx="8" ry="8" width="16" height="10" x="2" y="5" fill="currentColor"/><rect rx="5" ry="5" width="10" height="6" x="5" y="7" fill="var(--bg)"/><rect x="0" y="7" width="3" height="6" rx="1" fill="currentColor"/><rect x="17" y="7" width="3" height="6" rx="1" fill="currentColor"/></svg>',
    'QUEST PRO':    '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M2 10 L5 7 L15 7 L18 10 L15 13 L5 13 Z" stroke-width="1.5"/><line x1="2" y1="10" x2="18" y2="10" stroke-width="1"/></svg>',
    'QUEST 3':      '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><rect x="1" y="7" width="18" height="6" rx="2"/><circle cx="7" cy="10" r="2.2"/><circle cx="13" cy="10" r="2.2"/></svg>',
    '3D':           '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><path d="M10 2 L18 16 L2 16 Z"/><line x1="10" y1="2" x2="10" y2="16"/><line x1="6" y1="9" x2="14" y2="9"/></svg>',
    'WEBXR':        '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="10" cy="10" r="8"/><ellipse cx="10" cy="10" rx="8" ry="3"/></svg>',
    'INSTALLATION': '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><rect x="2" y="4" width="16" height="12" rx="1"/><line x1="7" y1="4" x2="7" y2="16"/><line x1="11" y1="4" x2="11" y2="16"/><line x1="15" y1="4" x2="15" y2="16"/></svg>',
};
